...
const NetworkAttachedContainers = () => {
    ...
    useEffect(() => {
        ...
        if (!containers.length) {
            ...
            setContainerList(filterContainersByNetworks());
        }
    }, [selectedNetwork, containers, loadContainers]);
...
export default NetworkAttachedContainers;