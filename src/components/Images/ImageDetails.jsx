    ...
    <>
        ...
        <div className="modal-box">
          ...
          <div className="py-2">
            <label className="flex items-center">
              <input type="checkbox" name="forceDelete" className="checkbox checkbox-primary mr-2" defaultChecked />
              Force
            </label>
          </div>
          <div className="py-2">
      ...
      <div className="dark p-4 bg-base-100 shadow-sm rounded-md h-full overflow-x-hidden flex flex-col">
        <div className="flex items-center">
          ...
          <button className="rounded" onClick={() => copyToClipboard(selectedImage.RepoTags[0])} title="Copy Image Name">
        ...
        <div className="flex mb-4">
          <div className="tooltip tooltip-bottom hover:tooltip-open z-10" data-tip="Export">
            ...
            >
              {loadingButton == "export-btn" ? <span className="loading loading-bars loading-xs"></span> : <IconBxExport className="size-5" />}
            </button>
          </div>
          ...
          <div className="tooltip tooltip-bottom hover:tooltip-open" data-tip="Delete">
            ...
            >
              {loadingButton == "delete-btn" ? <span className="loading loading-bars loading-xs"></span> : <IconBxTrashAlt className="size-5" />}
