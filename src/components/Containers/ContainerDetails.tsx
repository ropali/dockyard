  ...
  return (
    <div className="dark p-4 bg-base-100 shadow-sm rounded-md h-full overflow-x-hidden flex flex-col">
      ...
      <div className="flex mb-4 border-b border-base-300">
        <button
          className={`mr-4 pb-2 ${
            activeTab === 'LOGS' ? 'border-b-2 border-base-content' : ''
          }`}
        ...
        <button
          className={`pb-2 mr-4 ${
            activeTab === 'INFO' ? 'border-b-2 border-base-content' : ''
          }`}
        ...
        <button
          className={`mr-4 pb-2 ${
            activeTab === 'STATS' ? 'border-b-2 border-base-content' : ''
          }`}
        ...
        <button
          className={`mr-4 pb-2 ${
            activeTab === 'PROCESSES' ? 'border-b-2 border-base-content' : ''
          }`}
        ...
        <button
          className={`mr-4 pb-2 ${
            activeTab === 'ENV_VARS' ? 'border-b-2 border-base-content' : ''
          }`}
